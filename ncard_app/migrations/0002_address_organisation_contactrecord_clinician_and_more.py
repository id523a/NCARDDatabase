...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='contactrecord',
            name='address_home',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='contact_records_home', to='ncard_app.address', verbose_name='home address'),
        ),
        migrations.AddField(
            model_name='contactrecord',
            name='address_work',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='contact_records_work', to='ncard_app.address', verbose_name='work address'),
        ),
        migrations.AddField(
            model_name='contactrecord',
            name='employers',
